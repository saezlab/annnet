...
EXTRA_GROUPS = [
    ...
    (
        ...
        'Initial writes versus updates for node, edge, slice, and edge-slice annotations.',
    ),
    (
        'backend_operations',
...
OP_LABELS = {
    ...
    'add_nodes_bulk': 'add nodes\nbulk',
    'add_nodes_repeated': 'add nodes\nrepeated',
    'annotations_node_bulk': 'node attrs\nbulk',
    ...
    'set_node_attrs_bulk': 'node attrs\nbulk',
    'set_node_attrs_bulk_initial': 'node attrs\ninitial',
    'set_node_attrs_bulk_update': 'node attrs\nupdate',
