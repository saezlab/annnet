...
def run(scale):
    ...
    # ------------------------------------------------------------
    # 1) Node -> Edge creation + reification in one call
    # ------------------------------------------------------------
    edges = [
    ...
    # ------------------------------------------------------------
    # 2) Edge -> Edge creation + reification in one call
    # ------------------------------------------------------------
    edge_entities = [
    ...
    results["edge_to_edge_create"] = {
        "count": len(ee_ids),
        "wall_time_s": m_edge_edge["wall_time_s"],
        "rss_delta_mb": m_edge_edge["rss_delta_mb"],
    }
